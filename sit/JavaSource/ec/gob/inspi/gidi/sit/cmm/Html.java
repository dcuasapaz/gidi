...
public class Html {
	...
	public String lgoSecundary = "/img/lgo/secundary.png";
	...
	public String getPlhEml() {
		return plhEml;
	}

	public void setPlhEml(String plhEml) {
		this.plhEml = plhEml;
	}

	public String getPlhPss() {
		return plhPss;
	}

	public void setPlhPss(String plhPss) {
		this.plhPss = plhPss;
	}
